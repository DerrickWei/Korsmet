...
class ModelCustomerCustomer extends Model {
	public function addCustomer($data) { 
		...
		foreach ($data['address'] as $key => $address) { 
			$customer_data = $this->model_sync_sync->Auth("https://api.businesscentral.dynamics.com/v1.0/api/v1.0/companies(79e3a081-7ac2-45f7-998d-3d1b2e925d2a)/customers?\$filter=number eq '" . $address['custom_field'][2] . "'");

			$data['address'][$key]['custom_field'][1] = $customer_data['value'][0]['id'];
		}
