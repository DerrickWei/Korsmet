...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_environment'])) {
			$data['config_environment'] = $this->request->post['config_environment'];
		} else {
			$data['config_environment'] = $this->config->get('config_environment');
		}

		if (isset($this->request->post['config_low_stock'])) {
			$data['config_low_stock'] = $this->request->post['config_low_stock'];
		} else {
			$data['config_low_stock'] = $this->config->get('config_low_stock');
		}

		if (isset($this->request->post['config_medium_stock'])) {
			$data['config_medium_stock'] = $this->request->post['config_medium_stock'];
		} else {
			$data['config_medium_stock'] = $this->config->get('config_medium_stock');
		}

		if (isset($this->request->post['config_high_stock'])) {
			$data['config_high_stock'] = $this->request->post['config_high_stock'];
		} else {
			$data['config_high_stock'] = $this->config->get('config_high_stock');
		}
