...
class ModelAccountCustomer extends Model {
	...
	// Get Customer by Custom Field - Business Centrol Info stored in Custom Field
	public function getCustomerByCustomField($custom_field) {
		$query = $this->db->query("SELECT * 
									 FROM " . DB_PREFIX . "customer c 
							   INNER JOIN " . DB_PREFIX . "address a 
							           ON c.address_id = a.address_id 
									WHERE c.custom_field = '" . $this->db->escape($custom_field) . "'");
		return $query->row;
	}
}