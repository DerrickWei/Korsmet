...
class ModelAccountOrder extends Model {
	...
	public function getOrderProducts($order_id) {
		$query = $this->db->query("SELECT op.*, p.upc FROM " . DB_PREFIX . "order_product op JOIN " . DB_PREFIX . "product p ON p.product_id = op.product_id WHERE op.order_id = '" . (int)$order_id . "'");
